(() => {
  ...
  function openFqih(){ if(!navigator.onLine){showToast(t("fqihNeedsInternet"));return;} state.currentView="fqih";saveState();location.href=FQIH_URL; }
  ...
  function bind(){
    ...
    addEventListener("online",()=>{saveState();showToast(t("onlineNotice"))});
